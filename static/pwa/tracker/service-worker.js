...
self.addEventListener("install", function(e) {
    ...
    if ("GET" === e.request.method) {
        ...
        !t && "navigate" === e.request.mode && isPathWhitelisted(["^(?!\\/__).*"], e.request.url) && (n = new URL("/pwa/tracker/ulapphbot.html", self.location).toString(), t = urlsToCacheKeys.has(n)), t && e.respondWith(caches.open(cacheName).then(function(e) {
