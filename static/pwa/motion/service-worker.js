...
var precacheConfig = [
        ["/pwa/motion/motion.html", "132d3884d3dd3f78fa91f957ac8f2972"],
        ["/pwa/motion/devicemotion.html", "132d3884d3dd3f78fa91f957ac8f2973"],
        ["/audio/industrialAlarm.mp3", "132d3884d3dd3f78fa91f957ac8f2974"],
        ["/audio/industrialAlarm.ogg", "132d3884d3dd3f78fa91f957ac8f2975"],
...
self.addEventListener("install", function(e) {
    ...
    if ("GET" === e.request.method) {
        ...
        !t && "navigate" === e.request.mode && isPathWhitelisted(["^(?!\\/__).*"], e.request.url) && (n = new URL("/pwa/motion/ulapphbot.html", self.location).toString(), t = urlsToCacheKeys.has(n)), t && e.respondWith(caches.open(cacheName).then(function(e) {
