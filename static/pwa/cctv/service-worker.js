...
var precacheConfig = [
        ["/pwa/cctv/ulapphbot.html", "132d3884d3dd3f78fa91f957ac8f2972"],
...
self.addEventListener("install", function(e) {
    ...
    if ("GET" === e.request.method) {
        ...
        !t && "navigate" === e.request.mode && isPathWhitelisted(["^(?!\\/__).*"], e.request.url) && (n = new URL("/pwa/cctv/ulapphbot.html", self.location).toString(), t = urlsToCacheKeys.has(n)), t && e.respondWith(caches.open(cacheName).then(function(e) {
