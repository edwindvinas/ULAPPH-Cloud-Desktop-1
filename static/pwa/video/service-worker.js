...
var precacheConfig = [
        ["/pwa/video/video.html", "132d3884d3dd3f78fa91f957ac8f2972"],
    ...
    createCacheKey = function(e, t, n, r) {
        var a = new URL(e);
        return r && a.pathname.match(r) || (a.video += (a.video ? "&" : "") + encodeURIComponent(t) + "=" + encodeURIComponent(n)), a.toString()
    },
    ...
    stripIgnoredUrlParameters = function(e, t) {
        var n = new URL(e);
        return n.hash = "", n.video = n.video.slice(1).split("&").map(function(e) {
            return e.split("=")
        }).filter(function(e) {
...
self.addEventListener("install", function(e) {
    ...
    if ("GET" === e.request.method) {
        ...
        !t && "navigate" === e.request.mode && isPathWhitelisted(["^(?!\\/__).*"], e.request.url) && (n = new URL("/pwa/video/video.html", self.location).toString(), t = urlsToCacheKeys.has(n)), t && e.respondWith(caches.open(cacheName).then(function(e) {
